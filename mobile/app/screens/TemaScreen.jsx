<<<<<<< HEAD:mobile/app/screens/TemaScreen.jsx
        ...
        <View style={styles.temasContainer}>
          {temas.map((tema) => (
            <TouchableOpacity
              key={tema.nome}
              style={styles.temaButton}
              onPress={() => navigation.navigate(tema.tela)}  //descomentado para teste
              activeOpacity={0.8}
            >
              <Text style={styles.emoji}>{tema.emoji}</Text>
              <Text style={styles.temaText}>{tema.nome}</Text>
...
>>>>>>> 4a747b6abef2c01a9f44a9bb7056877afac03484:mobile/app/screens/Temas/TemaScreen.jsx
